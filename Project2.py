...
## Anyone you worked with on this project: Jake Kreinik
...
CACHED_FNAME = "206project2_caching.json"
try:
    cache_file = open(CACHED_FNAME, 'r')
...
def get_umsi_data():
    if "umsi_directory_data" in CACHE_DICTION:
        ...
        twitter_cache_file = open(CACHED_FNAME, 'w')
...
def get_five_tweets(search):
	...
	topfive = []
	for x in list_of_tweets[:5]:
		topfive.append(str(x["text"]))
	return topfive
